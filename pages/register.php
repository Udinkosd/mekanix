    ...
    <div class="min-h-screen flex fle-col items-center justify-center py-6 px-4">
      <div class="grid md:grid-cols-2 items-center gap-10 max-w-6xl w-full">
        <div class="max-md:text-center">
          ...
          <p class="text-sm mt-10">Already have an account? <a href="/pages/login.php" class="text-blue-600 font-semibold hover:underline ml-1">Sign in</a></p>
        </div>

        <form action="process_register.php" method="post" class="space-y-6 max-w-md md:ml-auto max-md:mx-auto w-full">
            ...
            <div>
                <input name="repeatpassword" type="password" autocomplete="current-password" required class="bg-gray-100 w-full text-sm px-4 py-3.5 rounded-md outline-blue-600" placeholder="Repeat Password" />
            </div>
            <div class="flex items-center justify-between">
                <div class="flex items-center">
                    <input id="terms-and-conditions" name="terms-and-conditions" type="checkbox" class="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded" required />
                    <label for="terms-and-conditions" class="ml-3 block text-sm">
